            ...
            <div className="flex h-[400px] ">
                ...
                <div className=" flex i  justify-center flex-col w-[50%] h-full p-[40px] bg-[#fbfbfc]">
                    ...
                    <p>
                        ...
                        bệnh viện lớn tại Sài Gòn đành đưa chú về nhà nằm chờ chết. Từ khi
                        chú Vũ bị bệnh đến nay gia đình đã vay mượn hơn 70 triệu đồng.
                    </p>
                    <a
                        href="#1"
                        className=" text-right duration-200 text-[#1e99bf] font-semibold hover:text-red-500"
                    >
                        Xem thêm{" "}
                    </a>
