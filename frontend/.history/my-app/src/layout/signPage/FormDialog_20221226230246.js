    ...
    return (
        <div>
            ...
            <Dialog open={check} >
                ...
                <DialogContent>
                    <DialogContentText>
                        Để đăng kí được tài khoản quản lý vui lòng nhập mã được cung cấp bởi Admin .Liên hệ qua facebook
                        <a href="https://www.facebook.com/nguyenne010102" className='text-blue-500 '> tại đây </a>
                        để biết thêm chi tiết về mã (để thuận tiện trong quá trình dùng thử website thì mã code là :
