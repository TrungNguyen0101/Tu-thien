...
const UploadImage = (url) => {
	console.log("🚀 ~ file: UploadImage.js:127 ~ UploadImage ~ url", url?.url)
	const dispatch = useDispatch()
	const [URL, setURL] = useState()
	console.log("🚀 ~ file: UploadImage.js:130 ~ UploadImage ~ URL", URL)
		...
		<div className="">
			{URL || url?.url &&
				<div className="mb-[20px]">
					<img src={URL || url?.url} alt="" className="w-full" />
				</div>
			}
			{loading &&
				<LoadingStyled>
