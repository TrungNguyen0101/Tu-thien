...
const UpdateUser = () => {
    ...
    const schema = yup
        .object({
            ...
            email: yup.string().email("Vui lòng nhập đúng định dạng").required("Vui lòng nhập vào email").nullable("12"),
            code: yup.string().required("Vui lòng nhập vào vào mã code").nullable("12"),
        }).required()
    const {
        control,
        handleSubmit,
