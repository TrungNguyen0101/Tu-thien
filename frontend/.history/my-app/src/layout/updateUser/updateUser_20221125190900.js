...
const UpdateUser = () => {
    ...
    // console.log("🚀 ~ file: updateUser.js ~ line 15 ~ UpdateUser ~ money", money)
    var nf = new Intl.NumberFormat();
    const a = nf.format(money); // "1,234,567,890"
    console.log("🚀 ~ file: updateUser.js ~ line 20 ~ UpdateUser ~ a", a)
