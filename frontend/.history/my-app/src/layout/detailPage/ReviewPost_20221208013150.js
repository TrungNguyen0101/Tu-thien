    ...
    return (
        <div>
            <div className="reviews py-[40px]">
                ...
                <div className="border-[1px] p-[10px] mb-[20px] h-[100px] overflow-auto relative">
                    {comment?.length > 0 && <div className="flex items-center justify-center gap-x-[20px]">
                        <span>
                            {comment[0]?.text}

                        </span>
                        <div
                            className="inline  hover:text-red-500"
