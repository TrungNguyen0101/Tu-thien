...
const ItemSupport = ({ item, ...props }) => {
    ...
    console.log("🚀 ~ file: ItemSupport.js:28 ~ ItemSupport ~ date", date)
    ...
    console.log("🚀 ~ file: ItemSupport.js:33 ~ ItemSupport ~ result1", result1)
    const formatDateEnd = new Date(result).toLocaleDateString("vi");
    console.log("🚀 ~ file: ItemSupport.js:35 ~ ItemSupport ~ formatDateEnd", formatDateEnd)
