    ...
    return (
        <nav>
                ...
                <ul>
                    ...
                    <li className="tooltip-element" data-tooltip={1}>
                        <NavLink
                            ...
                            className={({ isActive }) => {
                                return isActive
                                    ? " w-full h-[53px] bg-[#4a26ab] duration-300 rounded-[10px] "
                                    : "";
                            }}
            ...
            {user && (
                <div>
                    <div
                        className="w-full whitespace-nowrap pt-[30px] cursor-pointer hover:text-black duration-300 hide1"
            ...
            {user?.code === null && (
                <div className=" whitespace-normal mt-[0px] mb-[-20px] cursor-pointer text-black duration-300 hide1 font-semibold text-[13px] text-center w-[200px] m-auto">
