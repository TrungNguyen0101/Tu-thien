...
const ItemSupport = ({ item, ...props }) => {
    ...
    const [participantByPostID, setParticipantByPostId] = useState("");
    // console.log("🚀 ~ file: ItemSupport.js:20 ~ ItemSupport ~ participantByPostID", participantByPostID)
    ...
    async function handleGetAllParticipantByPostId(url) {
        ...
        const result = await response.json();
        console.log("🚀 ~ file: ItemSupport.js:70 ~ handleGetAllParticipantByPostId ~ result", result)
        return result
        // await setParticipantByPostId(result);
    }
    ...
    useEffect(() => {
        const handleCount = async () => {
            const count = await handleGetAllParticipantByPostId(`http://localhost:8080/api/participant/getCountParticipantByPostId?postId=${item?.id}`)
            console.log("🚀 ~ file: ItemSupport.js:242 ~ useEffect ~ count", item?.id)
        }
        handleCount()
    }, [item?.id])
    return (
            ...
            <div className="pb-[10px] mt-auto flex flex-col items-center">
                ...
                >
                    ...
                    <span className="mt-[10px]">
                        ...
                        <h3 className="inline text-[red] font-semibold">{"0/5"}</h3>
                    </span>
