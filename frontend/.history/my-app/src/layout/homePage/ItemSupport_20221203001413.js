...
const ItemSupport = ({ item, ...props }) => {
    ...
    console.log("🚀 ~ file: ItemSupport.js:20 ~ ItemSupport ~ participantByPostID", participantByPostID.length)
    ...
    useEffect(() => {
        ...
        handleGetAllParticipantByPostId(`http://localhost:8080/api/participant/getCountParticipantByPostId?postId=5=${item?.id}`)
