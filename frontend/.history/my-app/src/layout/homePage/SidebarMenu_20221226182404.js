    ...
    return (
        <nav>
            ...
            <div className="sidebar-footer">
                ...
                {user?.code === null && (
                    <div className=" whitespace-normal mt-[15px] mb-[-20px] cursor-pointer text-black duration-300 hide font-semibold text-[13px] text-center w-[200px] m-auto">
                        Vui lòng cập nhập mã code để lấy lại mất khẩu
                    </div>
                )}
                {user && (
                    <h3 className="text-[16px] pt-[20px] mb-[-20px] text-[#181818] font-bold  cursor-pointer text-center">
                        Đổi mật khẩu
                    </h3>
                )}
