...
const ItemSupport = ({ item, ...props }) => {
    ...
    const difference = differenceInDays(formatDateEnd, formatDateStart);
    console.log("🚀 ~ file: ItemSupport.js:32 ~ ItemSupport ~ formatDateStart", typeof formatDateStart)
    console.log("🚀 ~ file: ItemSupport.js:32 ~ ItemSupport ~ formatDateEnd", formatDateEnd)
