...
const ItemSupport = ({ item, ...props }) => {
    ...
    // console.log("🚀 ~ file: ItemSupport.js ~ line 13 ~ ItemSupport ~ date", date)
    const date1 = new Date(item?.createdAt);
    console.log("🚀 ~ file: ItemSupport.js ~ line 15 ~ ItemSupport ~ date1", date1.getDate())
    const formatDate = new Date(date1).toLocaleDateString("vi");
