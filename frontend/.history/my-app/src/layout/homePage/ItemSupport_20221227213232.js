        ...
        <div className="itemSupport-item border-2 flex flex-col items-center duration-200 mb-[20px]">
            <div className="relative p-0 h-[170px] w-[220px]">
                {item.status === 1 && difference > 0 && (
                    <ButtonStatus color1="#3376bc" color2="#91bbe5">Cần hỗ trợ</ButtonStatus>
                )}
                {item.status === 2 && (
                    <ButtonStatus color1="#f20231" color2="#efbf7f">Đang vận động</ButtonStatus>
                )}
                {item.status === 3 && (
                    <ButtonStatus color1="#407f3e" color2="#89b449">Đã hoàn thành</ButtonStatus>
                )}
                {item.status === 1 && difference < 0 && (
                    <ButtonStatus color1="#22162b" color2="#724e91">Chưa được hỗ trợ</ButtonStatus>
                )}
                <a href={item?.id}>
                    <img
                        src={item?.image}
