    ...
    return (
        <nav>
            ...
            <div className="sidebar-footer">
                ...
                {user?.code === null &&
                    <div
                        className=" whitespace-normal mt-[15px] mb-[-20px] cursor-pointer text-black duration-300 hide font-semibold text-[13px] text-center w-[200px] inline-block"
                        onClick={() => navigate("/update-user")}
                    >
                        Vui lòng cập nhập mã code để có thể lấy lại mất khẩu
                    </div>
