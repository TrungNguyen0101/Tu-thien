...
const ItemSupport = ({ item, ...props }) => {
    console.log("🚀 ~ file: ItemSupport.js:12 ~ ItemSupport ~ item", item)
    ...
    useEffect(() => {
        ...
        handleGetAllParticipantByPostId(`http://localhost:8080/api/participant/getAllParticipantByPostId?postId=${item?.id}`)
