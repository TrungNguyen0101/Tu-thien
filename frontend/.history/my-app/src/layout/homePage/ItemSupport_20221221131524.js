...
const ItemSupport = ({ item, ...props }) => {
    ...
    const startDate = format(result, 'dd/MM/yyyy');
    console.log("🚀 ~ file: ItemSupport.js:33 ~ ItemSupport ~ startDate", startDate)
    const end = new Date();
    const endDate = format(end, 'dd/MM/yyyy');
    const aEnd = new Date(startDate)
    console.log("🚀 ~ file: ItemSupport.js:37 ~ ItemSupport ~ aEnd", aEnd)
    // console.log("🚀 ~ file: ItemSupport.js:35 ~ ItemSupport ~ end", end)
    // const startDate = new Date(start);
    // const endDate = new Date(end);
    const difference = differenceInDays(startDate, endDate);
    console.log("🚀 ~ file: ItemSupport.js:41 ~ ItemSupport ~ difference", difference)
