...
const UpdatePost = () => {
    ...
    const schema = yup
        .object({
            ...
            totalParticipant: yup.string().required("Vui lòng nhập số lượng người tham gia").min(countParticipantByPostID, `Phải nhập hơn số lượng người đang tham gia: ${countParticipantByPostID} `),
        })
        .required();
    const {
        control,
