			...
			>
				...
				<div className="text-center pb-[30px]">
					<button
						disabled={isValid}
						type="submit"
						className={`cursor-pointer font-medium p-[10px] border-[2px] border-transparent bg-[#00b6f1]  text-white duration-300 text-[15px] text-center rounded-[10px]  w-[150px] ${isValid ? "opacity-60 hover:bg-white hover:text-[#00b6f1] hover:border-[#00b6f1] " : ""
							} `}
					// onClick={() => {
