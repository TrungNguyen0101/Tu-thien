...
const UpdatePost = () => {
    ...
    console.log("🚀 ~ file: UpdatePost.js:20 ~ UpdatePost ~ countParticipantByPostID", countParticipantByPostID)
    ...
    const schema = yup
        .object({
            ...
            totalParticipant: yup.number().min(countParticipantByPostID, `Phải nhập lớn hơn hoặc bằng số lượng người đang tham gia: ${countParticipantByPostID} `).required("Vui lòng nhập số lượng người tham gia"),
        })
        .required();
    const {
        control,
    ...
    console.log("🚀 ~ file: UpdatePost.js:39 ~ UpdatePost ~ isValid", isValid)
