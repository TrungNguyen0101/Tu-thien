...
const UploadImage = (url) => {
	...
	console.log("🚀 ~ file: UploadImage.js:132 ~ UploadImage ~ image", image)
	console.log("🚀 ~ file: UploadImage.js:132 ~ UploadImage ~ url?.url", url?.url)
		...
		<div className="">
			{URL || image &&
				<div className="mb-[20px]">
					<img src={URL || image} alt="" className="w-full" />
				</div>
			}
			{loading &&
				<LoadingStyled>
