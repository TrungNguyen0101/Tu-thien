                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div className="flex items-center gap-x-3 post">
                                            <img className="w-[40px] h-[40px] object-cover " src="https://nld.mediacdn.vn/2017/8-chan-1-1501857270466.jpg" alt="" />
                                            <div className="flex-1">
                                                <h3 title=" KỲ 382: CHA BỆNH, CON THƠ, LO CHẠY ĂN TỪNG BỮA, GIA ĐÌNH NGHÈO
