...
const Honor = () => {
    ...
    async function handleCallAPIGet(url) {
        ...
        console.log("🚀 ~ file: Honor.js:102 ~ handleCallAPIGet ~ data", data)
        return data
    }
    ...
    useEffect(() => {
        const handleGetAllAccount = async () => {
            const kq1 = await handleCallAPIGet(
                "https://pbl4-backend.vercel.app/api/auth/getAllAccount"
            );
            console.log("🚀 ~ file: Honor.js:111 ~ handleGetAllAccount ~ kq1", kq1)
            setAccount(kq1);
        };
