...
const Honor = () => {
    ...
    useEffect(() => {
        if (sortParticipant === "0") {
            setBxhParticipant(bxhParticipant.sort((a, b) => b.money - a.money))
            console.log("🚀 ~ file: Honor.js:139 ~ useEffect ~ bxhParticipant.sort((a, b) => b.money - a.money)", bxhParticipant.sort((a, b) => b.money - a.money))
            // setCheck(bxhParticipant.sort((a, b) => b.money - a.money))
            console.log(bxhParticipant);

        }
        else if (sortParticipant === "1") {
            setBxhParticipant(bxhParticipant.sort((a, b) => b.participant - a.participant))
            console.log(bxhParticipant);
        }
