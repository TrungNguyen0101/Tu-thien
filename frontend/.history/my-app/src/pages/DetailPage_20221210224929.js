...
const DetailPage = () => {
  ...
  console.log("🚀 ~ file: DetailPage.js:47 ~ DetailPage ~ participant", participant)
  ...
  console.log("🚀 ~ file: DetailPage.js:57 ~ DetailPage ~ setUserParticipant", userParticipant)
  ...
  return (
    <div className="flex">
      <main className="">
        ...
        <div className="m-auto mb-[20px]" onClick={() => handleUpdateFinish("")}>
