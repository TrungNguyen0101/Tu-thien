...
const Honor = () => {
    ...
    console.log("🚀 ~ file: Honor.js:45 ~ Honor ~ account", account)
    ...
    console.log(
        "🚀 ~ file: Honor.js:48 ~ Honor ~ bxhParticipant",
        bxhParticipant
    );
