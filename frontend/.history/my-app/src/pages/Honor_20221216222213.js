...
const Honor = () => {
    ...
    const [sortParticipant, setSortParticipant] = useState();
    console.log("🚀 ~ file: Honor.js:61 ~ Honor ~ sortParticipant", sortParticipant)
    let bxhParticipant = [];
            ...
            <div className="w-[50%]">
                <SelectStyles>
                    ...
                    <div className="custom-select">
                        <select onChange={(e) => { setSortParticipant(e.target) }}>
