...
const Honor = () => {
    ...
    console.log("🚀 ~ file: Honor.js:64 ~ Honor ~ bxhParticipant1", bxhParticipant1)
    ...
    useEffect(() => {
        ...
        if (countParticipant && sumMoney) {
            ...
            console.log("🚀 ~ file: Honor.js:70 ~ useEffect ~ array", array)
    ...
    useEffect(() => {
        let user = bxhParticipant.find((item) => item.username === "1234")
        console.log("🚀 ~ file: Honor.js:159 ~ useEffect ~ user", user)
    }, [])
    return (
