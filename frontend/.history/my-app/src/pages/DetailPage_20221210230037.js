...
const DetailPage = () => {
  ...
  console.log("🚀 ~ file: DetailPage.js:58 ~ DetailPage ~ leadParticipant", leadParticipant)
  const userLocal = JSON.parse(localStorage.getItem("userLogin"));
  const userId = userLocal?.id;

  console.log("🚀 ~ file: DetailPage.js:60 ~ DetailPage ~ leadParticipant", leadParticipant)
