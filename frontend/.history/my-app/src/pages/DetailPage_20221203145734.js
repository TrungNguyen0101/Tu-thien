...
const DetailPage = () => {
  ...
  const schema = yup
    .object({
      comment: yup.string().required("Vui lòng nhập vào nội dung"),
  ...
  console.log("🚀 ~ file: DetailPage.js:63 ~ DetailPage ~ errors", errors)
  console.log("🚀 ~ file: DetailPage.js:63 ~ DetailPage ~ isValid", isValid)
            ...
            <div className="reviews ">
              ...
              <div className="border-[1px] p-[10px] mb-[20px]">
                <div className="text-[13px]">
                  <h3 className="font-semibold inline">Trung nguyên :</h3>
                  <span className="inline">Hoạt động rất ý nghĩa</span>
                </div>
              </div>
              <form onSubmit={handleSubmit(submitForm)} className="text-center">
                <TextArea height="70px" padding="10px" name="comment" control={control}></TextArea>
                <button className="px-[10px] mt-[20px] py-[5px] bg-[#e22d28] text-center rounded-[5px] text-white font-medium">
                  Đăng bình luận
                </button>
              </form>
            </div>
