        ...
        countParticipant.forEach(item1 => {
            sumMoney.forEach(item2 => {
                if (item1.userId === item2.userId) {
                    bxhParticipant.push({ userId: item1.userId, participant: item1.participant, money: item2.money })
                }
            });
        });

    }
    console.log("🚀 ~ file: Honor.js:48 ~ Honor ~ bxhParticipant", bxhParticipant)
