  ...
  return (
    <div className="flex">
      <main className="">
        ...
        {post?.status !== 3 &&
          <div className="m-auto mb-[20px] mt-[20px]" onClick={() => handleUpdate()}>
            <ButtonDonate padding={"20px 80px"} size={"20px"} color={"#50C7C7"}>Hoàn thành thiện nguyện</ButtonDonate>
          </div>

        }
        {post?.status === 3 &&
          <div className="m-auto mb-[20px] mt-[20px]" >
            <span className="bg-[#2ba234] px-[80px] py-[20px] text-[20px] font-semibold text-white">Đã hoàn thành</span>
          </div>
