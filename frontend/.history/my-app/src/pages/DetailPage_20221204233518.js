...
const DetailPage = () => {
  ...
  const handleDeleteComment = (idUserComment, idComment) => {
    console.log("🚀 ~ file: DetailPage.js:355 ~ handleDeleteComment ~ idComment", idComment)
    console.log("🚀 ~ file: DetailPage.js:355 ~ handleDeleteComment ~ idUserComment", idUserComment)
    Swal.fire({
