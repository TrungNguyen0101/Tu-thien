        ...
        <div className="flex px-[40px] pt-[40px]">
          <div className="w-[65%] border-r-[2px] pr-[20px]">
            ...
            <div className="reviews py-[40px]">
              ...
              <form onSubmit={handleSubmit(submitReviewForm)} action=""></form>
              <TextArea
              ...
              <div className="m-auto text-center">
                <button type="submit" className="px-[10px] py-[5px] bg-[#e22d28] text-center rounded-[5px] text-white font-medium">
                  Viết đánh giá
                </button>
              </div>
            </div>
