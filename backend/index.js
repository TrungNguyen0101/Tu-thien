...
const routerDonate = require('./app/routes/donateRouter')
const routerParticipant = require('./app/routes/participantRouter')
const routerComment = require('./app/routes/commentRouter')
app.use('/api/auth', routerAuth)
app.use('/api/post', routerPost)
app.use('/api/donate', routerDonate)
app.use('/api/participant', routerParticipant)
