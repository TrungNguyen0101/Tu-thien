...
router.get('/getCountParticipantByUserId', participantController.getCountParticipantByUserId)
...
router.put('/UpdateFinishByPostId', participantController.UpdateFinishByPostId)
