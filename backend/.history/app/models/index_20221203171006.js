...
db.posts.belongsToMany(db.comments, { through: PostComments, foreignKey: 'commentId' });
db.comments.belongsToMany(db.posts, { through: PostComments, foreignKey: 'postIdd' });
