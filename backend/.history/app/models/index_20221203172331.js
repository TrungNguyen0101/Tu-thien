...
const PostComments = sequelize.define('userProjects', {
...
db.participants = require('./participant')(sequelize, DataTypes)
...
db.posts.belongsTo(db.accounts)// 1 post - 1 <a href=""></a>ccount
/* ---------------- post-participant(1-n) ----------------*/
db.posts.hasMany(db.participants)
db.participants.belongsTo(db.posts)
/* ---------------- post-donate(n-n) ----------------*/
...
/* ---------------- post-donate(n-n) ----------------*/
db.PostComments = PostComments
db.comments.belongsToMany(db.posts, { through: PostComments });
db.posts.belongsToMany(db.comments, { through: PostComments });
