...
db.posts.belongsToMany(db.comments, { through: PostComments, primaryKey: 'commentId' });
db.comments.belongsToMany(db.posts, { through: PostComments, primaryKey: 'postIdd' });
