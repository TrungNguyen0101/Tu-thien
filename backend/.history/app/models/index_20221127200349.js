...
db.postDonates = require('./postDonates')(sequelize, DataTypes)
...
db.posts.belongsToMany(db.donates, { through: db.postDonates });
db.donates.belongsToMany(db.posts, { through: db.postDonates });
